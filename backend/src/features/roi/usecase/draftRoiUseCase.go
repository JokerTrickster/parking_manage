...
type DraftRoiUseCase struct {
	ContextTimeout time.Duration
}

func NewDraftRoiUseCase(repo _interface.IDraftRoiRepository, timeout time.Duration) _interface.IDraftRoiUseCase {
	return &DraftRoiUseCase{ContextTimeout: timeout}
}

func (d *DraftRoiUseCase) CreateDraftRoi(c context.Context, projectID string, roiFileName string) error {
